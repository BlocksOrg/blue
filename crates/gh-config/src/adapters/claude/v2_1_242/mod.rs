...
pub static SPEC: VersionSpec = VersionSpec { operations: &CATALOG_PLUGIN_OPERATIONS, session_upload: Feature::Supported(session_upload_hooks), session_start: Feature::Supported(session_start_hooks), session_resume: Feature::Supported(()), support: &SUPPORT };
