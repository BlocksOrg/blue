...
| Variable | Effect |
| --- | --- |
| `BLUE_VERSION=0.2.0` | Install a specific release instead of the latest. |
...
| `blue status` | Show the remote tenant version, compare desired/applied revisions, and report managed-file and package health. |
