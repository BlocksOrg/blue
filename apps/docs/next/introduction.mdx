...
- Launch-scoped gateway routing with per-user pseudotokens.
...
| Bring your own gateway | Agent talks to the Blue inference proxy, which forwards to your gateway | An opaque per-user pseudotoken |
