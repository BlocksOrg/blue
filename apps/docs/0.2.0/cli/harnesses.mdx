...
See [Managed configuration](/0.2.0/concepts/managed-configuration) for the exact files on each side of that split and for what a governed launch inherits from your own configuration.
