...
See [Managed packages](/0.2.0/admin/managed-packages) for capability mapping and client installation behavior, and [Production deployment](/0.2.0/deployment/production) for storage and secret-management requirements.
