...
See [Governance configuration](/0.2.1/reference/governance-config) for the complete schema and [Troubleshooting](/0.2.1/cli/troubleshooting) for reconciliation diagnostics.
