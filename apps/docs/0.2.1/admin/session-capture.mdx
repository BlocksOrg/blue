...
independent of [gateway access](/0.2.1/admin/gateway-access) and does not inspect
...
[Blue YAML](/0.2.1/deployment/blue-yaml). The internal endpoint is used by the
