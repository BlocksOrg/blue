...
[session capture](/0.2.1/admin/session-capture): enabling either feature does
...
[custom executable provisioner](/0.2.1/admin/custom-gateway-provisioners) can
...
See [Bring your own gateway](/0.2.1/concepts/gateway-mode) for deployment topology and
[Blue YAML](/0.2.1/deployment/blue-yaml) for the complete configuration schema.
