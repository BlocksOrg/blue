...
See [Harness adapter architecture](/0.1.0/development/harness-adapter-architecture) for the version-range contract, operation-set ownership, package compatibility, and required boundary tests.

See [Gateway adapter architecture](/0.1.0/development/gateway-adapter-architecture) for the compiled registry, service and harness ownership boundaries, provisioning choices, proxy changes, and end-to-end verification.
