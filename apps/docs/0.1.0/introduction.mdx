...
<Columns cols={3}>
  ...
  <Card title="Quickstart" icon="rocket" href="/0.1.0/quickstart">
    Deploy the services, connect the CLI, and launch a governed agent.
  </Card>
  <Card title="For operators" icon="server" href="/0.1.0/deployment/runtime-contract">
...
See [Managed packages](/0.1.0/admin/managed-packages) for publishing and removal, and [Configuration lifecycle](/0.1.0/concepts/configuration) for reconciliation behavior.
...
Read [Architecture](/0.1.0/concepts/architecture) for the complete data flow.
