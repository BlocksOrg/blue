...
| [Extensions](/0.1.0/admin/managed-packages) | Select skills, hooks, subagents, plugins, helper binaries, and MCP servers for managed distribution. |
| Current deployment configuration | Open the user-menu dialog to copy or download effective deployment YAML. |
| [Members](/0.1.0/admin/user-management) | Invite users, manage roles and access state, revoke credentials, and retain account history. |
...
The bootstrap administrator is protected from demotion, suspension, and deletion. See [Manage users and invitations](/0.1.0/admin/user-management) for the complete lifecycle and API behavior.
