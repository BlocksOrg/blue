...
[session capture](/0.1.0/admin/session-capture): enabling either feature does
...
[custom executable provisioner](/0.1.0/admin/custom-gateway-provisioners) can
...
See [Bring your own gateway](/0.1.0/concepts/gateway-mode) for deployment topology and
[Blue YAML](/0.1.0/deployment/blue-yaml) for the complete configuration schema.
