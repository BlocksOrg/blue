...
independent of [gateway access](/0.1.0/admin/gateway-access) and does not inspect
...
[Blue YAML](/0.1.0/deployment/blue-yaml). The internal endpoint is used by the
